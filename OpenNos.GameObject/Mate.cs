...
namespace OpenNos.GameObject
{
    public class Mate : MateDTO
    {
        ...
        {
            ItemInstance sp = Owner.Session.Character.Inventory.LoadBySlotAndType((byte)EquipmentType.Sp, InventoryType.Wear);
            ...
            if (sp.ItemVNum == 4582 && sp.Item.Morph == 40 && Owner.Session.Character.Class == ClassType.Archer && IsTemporalMate)
            {
                Owner.Session.SendPacket(UserInterfaceHelper.GenerateMsg(Language.Instance.GetMessageFromKey("WOLF_DEAD"), 0));
                return;
            }
