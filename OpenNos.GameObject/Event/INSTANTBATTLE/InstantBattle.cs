    ...
    public static class InstantBattle
    {
        ...
        public static void GenerateInstantBattle()
        {
            ...
            foreach (ClientSession s in sessions.OrderBy(s => s.Character?.Level))
            {
                ...
                if (map != null)
                { // try it again k :D
                    ServerManager.Instance.ChangeMapInstance(s.Character.CharacterId, map.MapInstanceId, 34, 68);
                }
        ...
        public class InstantBattleTask
        {
            ...
            private static InstantBattleWaveReward getInstantBattleDrop(Map map, short instantbattletype, int wave)
            {
                ...
                {
                    case 1:
                        reward.Gold = (wave + 1) * 10000;
                        switch (wave)
                        {
                            case 0:
                                reward.Items.Add(new InstantBattleItem { VNum = 2027, Amount = 10 });
                            ...
                            case 1:
                                ...
                                reward.Items.Add(new InstantBattleItem { VNum = 1004, Amount = 5 });
                                reward.Items.Add(new InstantBattleItem { VNum = 181, Amount = 1 });
                                break;

                            case 2:
                                reward.Items.Add(new InstantBattleItem { VNum = 1004, Amount = 30 });
                                reward.Items.Add(new InstantBattleItem { VNum = 1007, Amount = 30 });
                                reward.Items.Add(new InstantBattleItem { VNum = 1010, Amount = 30 });
                                reward.Items.Add(new InstantBattleItem { VNum = 1013, Amount = 30 });
                                break;

                            case 3:
                                reward.Items.Add(new InstantBattleItem { VNum = 1003, Amount = 10 });
                                reward.Items.Add(new InstantBattleItem { VNum = 1006, Amount = 10 });
                                break;
                        }
                        break;

                    case 40:
                        reward.Gold = (wave + 1) * 20000;
                        switch (wave)
                        {
                            case 0:
                                reward.Items.Add(new InstantBattleItem { VNum = 1011, Amount = 10 });
                                reward.Items.Add(new InstantBattleItem { VNum = 2282, Amount = 10 });
                                reward.Items.Add(new InstantBattleItem { VNum = 1030, Amount = 10 });
                                break;

                            case 1:
                                reward.Items.Add(new InstantBattleItem { VNum = 1011, Amount = 20 });
                                reward.Items.Add(new InstantBattleItem { VNum = 2282, Amount = 20 });
                                reward.Items.Add(new InstantBattleItem { VNum = 1030, Amount = 20 });
                                break;

                            case 2:
                                reward.Items.Add(new InstantBattleItem { VNum = 1011, Amount = 30 });
                                reward.Items.Add(new InstantBattleItem { VNum = 2282, Amount = 30 });
                                reward.Items.Add(new InstantBattleItem { VNum = 1030, Amount = 30 });
                                break;

                            case 3:
                                reward.Items.Add(new InstantBattleItem { VNum = 1011, Amount = 50 });
                                reward.Items.Add(new InstantBattleItem { VNum = 2282, Amount = 50 });
                                reward.Items.Add(new InstantBattleItem { VNum = 1030, Amount = 50 });
                                reward.Items.Add(new InstantBattleItem { VNum = 40071, Amount = 1 });
                                break;
                        }
                    ...
                    case 50:
                        reward.Gold = (wave + 1) * 30000;
                        switch (wave)
                        {
                            case 0:
                                reward.Items.Add(new InstantBattleItem { VNum = 1011, Amount = 20 });
                                reward.Items.Add(new InstantBattleItem { VNum = 1122, Amount = 20 });
                                reward.Items.Add(new InstantBattleItem { VNum = 2282, Amount = 20 });
                                reward.Items.Add(new InstantBattleItem { VNum = 1030, Amount = 20 });
                                break;
                            ...
                            case 1:
                                reward.Items.Add(new InstantBattleItem { VNum = 1011, Amount = 30 });
                                reward.Items.Add(new InstantBattleItem { VNum = 1122, Amount = 30 });
                                reward.Items.Add(new InstantBattleItem { VNum = 2282, Amount = 30 });
                                reward.Items.Add(new InstantBattleItem { VNum = 1030, Amount = 30 });
                                break;

                            case 2:
                                reward.Items.Add(new InstantBattleItem { VNum = 1011, Amount = 40 });
                                reward.Items.Add(new InstantBattleItem { VNum = 1122, Amount = 40 });
                                reward.Items.Add(new InstantBattleItem { VNum = 2282, Amount = 40 });
                                reward.Items.Add(new InstantBattleItem { VNum = 1030, Amount = 40 });
                                break;

                            case 3:
                                reward.Items.Add(new InstantBattleItem { VNum = 1011, Amount = 60 });
                                reward.Items.Add(new InstantBattleItem { VNum = 1122, Amount = 60 });
                                reward.Items.Add(new InstantBattleItem { VNum = 2282, Amount = 60 });
                                reward.Items.Add(new InstantBattleItem { VNum = 1030, Amount = 60 });
                                reward.Items.Add(new InstantBattleItem { VNum = 40071, Amount = 1 });
                                break;
                        }
                        break;
                    ...
                    case 60:
                        reward.Gold = (wave + 1) * 40000;
                        switch (wave)
                        {
                            case 0:
                                reward.Items.Add(new InstantBattleItem { VNum = 1011, Amount = 25 });
                                reward.Items.Add(new InstantBattleItem { VNum = 1122, Amount = 25 });
                                reward.Items.Add(new InstantBattleItem { VNum = 2282, Amount = 25 });
                                reward.Items.Add(new InstantBattleItem { VNum = 1030, Amount = 25 });
                            ...
                            case 1:
                                ...
                                reward.Items.Add(new InstantBattleItem { VNum = 2282, Amount = 40 });
                                reward.Items.Add(new InstantBattleItem { VNum = 1030, Amount = 40 });
                                reward.Items.Add(new InstantBattleItem { VNum = 1363, Amount = 4 });
                                reward.Items.Add(new InstantBattleItem { VNum = 1364, Amount = 3 });
                                break;
                            ...
                            case 2:
                                ...
                                reward.Items.Add(new InstantBattleItem { VNum = 2282, Amount = 60 });
                                reward.Items.Add(new InstantBattleItem { VNum = 1030, Amount = 60 });
                                reward.Items.Add(new InstantBattleItem { VNum = 1363, Amount = 5 });
                                reward.Items.Add(new InstantBattleItem { VNum = 1364, Amount = 5 });
                                break;

                            case 3:
                                reward.Items.Add(new InstantBattleItem { VNum = 1011, Amount = 90 });
                                reward.Items.Add(new InstantBattleItem { VNum = 1122, Amount = 90 });
                                reward.Items.Add(new InstantBattleItem { VNum = 2282, Amount = 90 });
                                reward.Items.Add(new InstantBattleItem { VNum = 1030, Amount = 90 });
                                reward.Items.Add(new InstantBattleItem { VNum = 1363, Amount = 5 });
                                reward.Items.Add(new InstantBattleItem { VNum = 1364, Amount = 5 });
                                reward.Items.Add(new InstantBattleItem { VNum = 40071, Amount = 1 });
                                break;
                    ...
                    case 70:
                        ...
                        switch (wave)
                        {
                            ...
                            case 1:
                                reward.Items.Add(new InstantBattleItem { VNum = 1011, Amount = 50 });
                                reward.Items.Add(new InstantBattleItem { VNum = 1122, Amount = 50 });
                                reward.Items.Add(new InstantBattleItem { VNum = 2282, Amount = 50 });
                                reward.Items.Add(new InstantBattleItem { VNum = 1030, Amount = 50 });
                                reward.Items.Add(new InstantBattleItem { VNum = 1363, Amount = 4 });
                                reward.Items.Add(new InstantBattleItem { VNum = 1364, Amount = 4 });
                                break;

                            case 2:
                                reward.Items.Add(new InstantBattleItem { VNum = 1011, Amount = 70 });
                                reward.Items.Add(new InstantBattleItem { VNum = 1122, Amount = 70 });
                                reward.Items.Add(new InstantBattleItem { VNum = 2282, Amount = 70 });
                                reward.Items.Add(new InstantBattleItem { VNum = 1030, Amount = 70 });
                                reward.Items.Add(new InstantBattleItem { VNum = 1363, Amount = 5 });
                                reward.Items.Add(new InstantBattleItem { VNum = 1364, Amount = 5 });
                                break;

                            case 3:
                                reward.Items.Add(new InstantBattleItem { VNum = 1011, Amount = 99 });
                                reward.Items.Add(new InstantBattleItem { VNum = 1122, Amount = 99 });
                                reward.Items.Add(new InstantBattleItem { VNum = 2282, Amount = 99 });
                                reward.Items.Add(new InstantBattleItem { VNum = 1030, Amount = 99 });
                                reward.Items.Add(new InstantBattleItem { VNum = 1363, Amount = 6 });
                                reward.Items.Add(new InstantBattleItem { VNum = 1364, Amount = 6 });
                                reward.Items.Add(new InstantBattleItem { VNum = 40071, Amount = 1 });
                                break;
                        }
                        break;
                    ...
                    case 80:
                        switch (wave)
                        {
                            case 0:
                                reward.Gold = 20000;
                                reward.Items.Add(new InstantBattleItem { VNum = 1011, Amount = 10 });
                                reward.Items.Add(new InstantBattleItem { VNum = 1246, Amount = 3 });
                                break;

                            case 1:
                                reward.Gold = 30000;
                                reward.Items.Add(new InstantBattleItem { VNum = 1011, Amount = 10 });
                                reward.Items.Add(new InstantBattleItem { VNum = 1247, Amount = 3 });
                                break;
                            ...
                            case 3:
                                reward.Gold = 50000;
                                reward.Items.Add(new InstantBattleItem { VNum = 1011, Amount = 10 });
                                reward.Items.Add(new InstantBattleItem { VNum = 1030, Amount = 5 });
                                reward.Items.Add(new InstantBattleItem { VNum = 2282, Amount = 20 });
                                break;
                        }
                        break;
