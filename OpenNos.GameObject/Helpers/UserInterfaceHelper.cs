...
namespace OpenNos.GameObject.Helpers
{
    public class UserInterfaceHelper
    {
        ...
        public static string GenerateGuri(byte type, byte argument, long callerId, int value = 0, int value2 = 0) 
        {
            ...
            {
                case 2:
                    return $"guri 2 {argument} {callerId} 0";
                ...
                case 12:
                    return $"guri 12 1 {callerId} {value} 0";
                ...
                default:
                    return $"guri {type} {argument} {callerId} {value} 0";
            }
        }
        ...
        {
            string removePacket = $"{Slot}.0.0.0.0.0.0"; // Offizielles leeres Inventar-Paket
            Console.WriteLine($"DEBUG: Entferne Item aus Slot {Slot} mit Paket: ivn {(byte)Type} {removePacket}");
            return $"ivn {(byte)Type} {removePacket}";
        }
